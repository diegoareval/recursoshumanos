 ...
 * @author DiegoArevalo
 */
public class EmpleadoDao extends DaoGeneral{
...
//lista que contendra todos los registros de todos los bancos
        ...
        try {
            ...
            listado =(List<Empleados>) query.list();
    ...
    public List<Empleados> listAllParameter(String parameter) {
       //atributo que contendra los registros encontrados
        ...
        try {
           ...
           //select * from bancos where descripcion like %'sco'%
            Query query = session.createQuery("From Empleados where nombres like '%"+parameter+"%' or apellidos like '%"+parameter+"%'");
            listado =(List<Empleados>) query.list();
     ...
     public List<Empleados> buscarporID(int parameter) {
       //atributo que contendra los registros encontrados
        List<Empleados> listado = null;
        Transaction tx = null;
        try {
           ...
           //query que permite encontrar los registros por medio de una busqueda
           //select * from bancos where descripcion like %'sco'%
            Query query = session.createQuery("From Empleados where idempleado= '"+parameter+"%'");
            listado =(List<Empleados>) query.list();
            //permite ejecutar toda la consulta
            tx.commit();
