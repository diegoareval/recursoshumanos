...
private Usuarios usuario = null;
    ...
    public Principal() {
     ...
     public void SetUsuario(Usuarios usuario) {
       ...
       // lblusuario.setText("Hola, " + usuario.getUsuario());
    ...
    private void initComponents() {
        ...
        uno.setText("Inicio");
        uno.setColorHover(new java.awt.Color(153, 153, 255));
        ...
        tres.setColorHover(new java.awt.Color(153, 153, 255));
        ...
        dos.setColorHover(new java.awt.Color(153, 153, 255));
        ...
        cinco.setColorHover(new java.awt.Color(153, 153, 255));
        ...
        ocho.setColorHover(new java.awt.Color(153, 153, 255));
        ...
        siete.setColorHover(new java.awt.Color(153, 153, 255));
        ...
        seis.setText("Planes");
        seis.setColorHover(new java.awt.Color(153, 153, 255));
        ...
        cuatro.setColorHover(new java.awt.Color(153, 153, 255));
        ...
        jMenuItem5.setText("Pago Mensual");
   ...
   // jLabel4.setText(configuracion.getNombresistema());
    ...
    private void unoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_unoActionPerformed
        ...
        if(this.uno.isSelected()){
            ...
            this.uno.setColorNormal(new Color(255,55,555));
            this.uno.setColorHover(new Color(0,0,0));
            this.uno.setColorPressed(new Color(204,204,204));
        }
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
       frmPagoMensual frm=new frmPagoMensual();
       frm.setVisible(true);
    }//GEN-LAST:event_jMenuItem5ActionPerformed

    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
       frmPlanillaAnual frm=new frmPlanillaAnual();
       frm.setVisible(true);
